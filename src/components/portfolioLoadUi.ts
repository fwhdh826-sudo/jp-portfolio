...
/**
 * RA-008-D2: cross-tab stale warningの唯一のmessage source。
 * StatusBarのcross-tab warning表示もこの定数をimportし、hard-codeされた重複文言を持たない。
 */
export const CROSS_TAB_STATE_STALE_MESSAGE =
  '別タブで更新された状態を検出しました。画面を再読み込みしてください。'
...
const COORDINATION_MESSAGES: Record<PortfolioCoordinationErrorCode, string> = {
  ...
  CROSS_TAB_STATE_STALE: CROSS_TAB_STATE_STALE_MESSAGE,
