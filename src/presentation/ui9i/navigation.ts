...
export const FUNDS_HUB_LINKS: readonly HubLink[] = [
  { id: 'jp-fund', title: '国内投信', description: '短期回転の判断と地合い', glyph: '国', target: { tab: 'T2', surface: null } },
  { id: 'global-fund', title: '海外投信', description: '中長期配分と為替の影響', glyph: '海', target: { tab: 'T3', surface: null } },
  { id: 'fund-management', title: '投信管理', description: '当日の実行キューと資金配分', glyph: '管', target: { tab: 'T7', surface: null } },
]

export const OTHER_HUB_LINKS: readonly HubLink[] = [
  { id: 'news', title: 'ニュース', description: '市場と保有銘柄に関する記事', glyph: 'ニ', target: { tab: 'T5', surface: null } },
  { id: 'committee', title: 'AI委員会', description: '代理の議論と論点（判断の背景）', glyph: 'AI', target: { tab: 'T6', surface: null } },
  { id: 'learning', title: '学習・検証', description: '予測と実績、戦略の検証', glyph: '学', target: { tab: 'T8', surface: null } },
  { id: 'settings', title: '設定', description: 'データ更新・CSV取込・保有設定', glyph: '設', target: { tab: 'T9', surface: null } },
  { id: 'legacy-home', title: '従来のホーム', description: '旧ダッシュボードの詳細カード一覧', glyph: '旧', target: { tab: null, surface: 'legacy_home' } },
]

/** PF 面から到達できる既存画面（旧 T4 理想PF）。 */
export const PF_SURFACE_LINKS: readonly HubLink[] = [
  { id: 'ideal-pf', title: '理想ポートフォリオ / 差分', description: 'ゼロベースの理想PFと現在PFの差分', glyph: '理', target: { tab: 'T4', surface: null } },
]
